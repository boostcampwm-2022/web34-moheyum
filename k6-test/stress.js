...
export const options = {
  stages: [
    { duration: '1m', target: targetVU }, // below normal load
    { duration: '2m', target: targetVU },
    { duration: '1m', target: targetVU*2 }, // normal load
    { duration: '2m', target: targetVU*2 },
    { duration: '1m', target: targetVU*3 }, // around the breaking point
    { duration: '2m', target: targetVU*3 },
    { duration: '1m', target: targetVU*4 }, // beyond the breaking point
    { duration: '2m', target: targetVU*4 },
